...
Public Class DowStockDB
    ...
    Public Shared Function deleteDowStock(ByVal strTicker As String) As Integer
        Dim connection As SqlConnection = getConnection()
        Dim strDeleteStatement As String = "DELETE FROM [DowIndustrialsSQL].[dbo].[tblDowStocks] " _
    ...
    Public Shared Function insertDowStock(ByRef stock As clsDowStock) As Integer
        ...
        Dim strInsertStatement As String = "INSERT INTO [DowIndustrialsSQL].[dbo].[tblDowStocks] (Ticker, StockName, DivShare) " _
